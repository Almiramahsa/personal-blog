...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    <div className="absolute rounded-lg bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-500 to-black w-full h-72" />
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-white left-4 rounded-full">
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-white right-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className=" text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
